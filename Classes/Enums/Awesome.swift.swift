...
public struct Awesome.swift {
	...
	public enum regular: String, Amazing {
		...
		public static var labels: [String] {
			return [ "Address Book", "Address Card", "Alternate Arrow Circle Down", "Alternate Arrow Circle Left", "Alternate Arrow Circle Right", "Alternate Arrow Circle Up", "bell", "Bell Slash", "bookmark", "Building", "Calendar", "Alternate Calendar", "Calendar Check", "Calendar Minus", "Calendar Plus", "Calendar Times", "Caret Square Down", "Caret Square Left", "Caret Square Right", "Caret Square Up", "Bar Chart", "Check Circle", "Check Square", "Circle", "Clipboard", "Clock", "Clone", "Closed Captioning", "comment", "Alternate Comment", "Comment Dots", "comments", "Compass", "Copy", "Copyright", "Credit Card", "Dot Circle", "Edit", "Envelope", "Envelope Open", "Eye", "Eye Slash", "File", "Alternate File", "Archive File", "Audio File", "Code File", "Excel File", "Image File", "PDF File", "Powerpoint File", "Video File", "Word File", "flag", "Folder", "Folder Open", "Font Awesome Full Logo", "Frown", "Futbol", "Gem", "Lizard (Hand)", "Paper (Hand)", "Peace (Hand)", "Hand Pointing Down", "Hand Pointing Left", "Hand Pointing Right", "Hand Pointing Up", "Pointer (Hand)", "Rock (Hand)", "Scissors (Hand)", "Spock (Hand)", "Handshake", "HDD", "Heart", "hospital", "Hourglass", "Identification Badge", "Identification Card", "Image", "Images", "Keyboard", "Lemon", "Life Ring", "Lightbulb", "Alternate List", "Map", "Meh", "Minus Square", "Alternate Money Bill", "Moon", "Newspaper", "Object Group", "Object Ungroup", "Paper Plane", "Pause Circle", "Play Circle", "Plus Square", "Question Circle", "Registered Trademark", "Save", "Share Square", "Smile", "Snowflake", "Square", "Star", "star-half", "Sticky Note", "Stop Circle", "Sun", "thumbs-down", "thumbs-up", "Times Circle", "Alternate Trash", "User", "User Circle", "Window Close", "Window Maximize", "Window Minimize", "Window Restore" ]
		}
	...
	public enum solid: String, Amazing {
		...
		public static var all: [solid] {
			return [ solid.addressBook, solid.addressCard, solid.adjust, solid.alignCenter, solid.alignJustify, solid.alignLeft, solid.alignRight, solid.allergies, solid.ambulance, solid.americanSignLanguageInterpreting, solid.anchor, solid.angleDoubleDown, solid.angleDoubleLeft, solid.angleDoubleRight, solid.angleDoubleUp, solid.angleDown, solid.angleLeft, solid.angleRight, solid.angleUp, solid.archive, solid.arrowAltCircleDown, solid.arrowAltCircleLeft, solid.arrowAltCircleRight, solid.arrowAltCircleUp, solid.arrowCircleDown, solid.arrowCircleLeft, solid.arrowCircleRight, solid.arrowCircleUp, solid.arrowDown, solid.arrowLeft, solid.arrowRight, solid.arrowUp, solid.arrowsAlt, solid.arrowsAltH, solid.arrowsAltV, solid.assistiveListeningSystems, solid.asterisk, solid.at, solid.audioDescription, solid.backward, solid.balanceScale, solid.ban, solid.bandAid, solid.barcode, solid.bars, solid.baseballBall, solid.basketballBall, solid.bath, solid.batteryEmpty, solid.batteryFull, solid.batteryHalf, solid.batteryQuarter, solid.batteryThreeQuarters, solid.bed, solid.beer, solid.bell, solid.bellSlash, solid.bicycle, solid.binoculars, solid.birthdayCake, solid.blender, solid.blind, solid.bold, solid.bolt, solid.bomb, solid.book, solid.bookOpen, solid.bookmark, solid.bowlingBall, solid.box, solid.boxOpen, solid.boxes, solid.braille, solid.briefcase, solid.briefcaseMedical, solid.broadcastTower, solid.broom, solid.bug, solid.building, solid.bullhorn, solid.bullseye, solid.burn, solid.bus, solid.calculator, solid.calendar, solid.calendarAlt, solid.calendarCheck, solid.calendarMinus, solid.calendarPlus, solid.calendarTimes, solid.camera, solid.cameraRetro, solid.capsules, solid.car, solid.caretDown, solid.caretLeft, solid.caretRight, solid.caretSquareDown, solid.caretSquareLeft, solid.caretSquareRight, solid.caretSquareUp, solid.caretUp, solid.cartArrowDown, solid.cartPlus, solid.certificate, solid.chalkboard, solid.chalkboardTeacher, solid.chartArea, solid.chartBar, solid.chartLine, solid.chartPie, solid.check, solid.checkCircle, solid.checkSquare, solid.chess, solid.chessBishop, solid.chessBoard, solid.chessKing, solid.chessKnight, solid.chessPawn, solid.chessQueen, solid.chessRook, solid.chevronCircleDown, solid.chevronCircleLeft, solid.chevronCircleRight, solid.chevronCircleUp, solid.chevronDown, solid.chevronLeft, solid.chevronRight, solid.chevronUp, solid.child, solid.church, solid.circle, solid.circleNotch, solid.clipboard, solid.clipboardCheck, solid.clipboardList, solid.clock, solid.clone, solid.closedCaptioning, solid.cloud, solid.cloudDownloadAlt, solid.cloudUploadAlt, solid.code, solid.codeBranch, solid.coffee, solid.cog, solid.cogs, solid.coins, solid.columns, solid.comment, solid.commentAlt, solid.commentDots, solid.commentSlash, solid.comments, solid.compactDisc, solid.compass, solid.compress, solid.copy, solid.copyright, solid.couch, solid.creditCard, solid.crop, solid.crosshairs, solid.crow, solid.crown, solid.cube, solid.cubes, solid.cut, solid.database, solid.deaf, solid.desktop, solid.diagnoses, solid.dice, solid.diceFive, solid.diceFour, solid.diceOne, solid.diceSix, solid.diceThree, solid.diceTwo, solid.divide, solid.dna, solid.dollarSign, solid.dolly, solid.dollyFlatbed, solid.donate, solid.doorClosed, solid.doorOpen, solid.dotCircle, solid.dove, solid.download, solid.dumbbell, solid.edit, solid.eject, solid.ellipsisH, solid.ellipsisV, solid.envelope, solid.envelopeOpen, solid.envelopeSquare, solid.equals, solid.eraser, solid.euroSign, solid.exchangeAlt, solid.exclamation, solid.exclamationCircle, solid.exclamationTriangle, solid.expand, solid.expandArrowsAlt, solid.externalLinkAlt, solid.externalLinkSquareAlt, solid.eye, solid.eyeDropper, solid.eyeSlash, solid.fastBackward, solid.fastForward, solid.fax, solid.feather, solid.female, solid.fighterJet, solid.file, solid.fileAlt, solid.fileArchive, solid.fileAudio, solid.fileCode, solid.fileExcel, solid.fileImage, solid.fileMedical, solid.fileMedicalAlt, solid.filePdf, solid.filePowerpoint, solid.fileVideo, solid.fileWord, solid.film, solid.filter, solid.fire, solid.fireExtinguisher, solid.firstAid, solid.flag, solid.flagCheckered, solid.flask, solid.folder, solid.folderOpen, solid.font, solid.fontAwesomeLogoFull, solid.footballBall, solid.forward, solid.frog, solid.frown, solid.futbol, solid.gamepad, solid.gasPump, solid.gavel, solid.gem, solid.genderless, solid.gift, solid.glassMartini, solid.glasses, solid.globe, solid.golfBall, solid.graduationCap, solid.greaterThan, solid.greaterThanEqual, solid.hSquare, solid.handHolding, solid.handHoldingHeart, solid.handHoldingUsd, solid.handLizard, solid.handPaper, solid.handPeace, solid.handPointDown, solid.handPointLeft, solid.handPointRight, solid.handPointUp, solid.handPointer, solid.handRock, solid.handScissors, solid.handSpock, solid.hands, solid.handsHelping, solid.handshake, solid.hashtag, solid.hdd, solid.heading, solid.headphones, solid.heart, solid.heartbeat, solid.helicopter, solid.history, solid.hockeyPuck, solid.home, solid.hospital, solid.hospitalAlt, solid.hospitalSymbol, solid.hourglass, solid.hourglassEnd, solid.hourglassHalf, solid.hourglassStart, solid.iCursor, solid.idBadge, solid.idCard, solid.idCardAlt, solid.image, solid.images, solid.inbox, solid.indent, solid.industry, solid.infinity, solid.info, solid.infoCircle, solid.italic, solid.key, solid.keyboard, solid.kiwiBird, solid.language, solid.laptop, solid.leaf, solid.lemon, solid.lessThan, solid.lessThanEqual, solid.levelDownAlt, solid.levelUpAlt, solid.lifeRing, solid.lightbulb, solid.link, solid.liraSign, solid.list, solid.listAlt, solid.listOl, solid.listUl, solid.locationArrow, solid.lock, solid.lockOpen, solid.longArrowAltDown, solid.longArrowAltLeft, solid.longArrowAltRight, solid.longArrowAltUp, solid.lowVision, solid.magic, solid.magnet, solid.male, solid.map, solid.mapMarker, solid.mapMarkerAlt, solid.mapPin, solid.mapSigns, solid.mars, solid.marsDouble, solid.marsStroke, solid.marsStrokeH, solid.marsStrokeV, solid.medkit, solid.meh, solid.memory, solid.mercury, solid.microchip, solid.microphone, solid.microphoneAlt, solid.microphoneAltSlash, solid.microphoneSlash, solid.minus, solid.minusCircle, solid.minusSquare, solid.mobile, solid.mobileAlt, solid.moneyBill, solid.moneyBillAlt, solid.moneyBillWave, solid.moneyBillWaveAlt, solid.moneyCheck, solid.moneyCheckAlt, solid.moon, solid.motorcycle, solid.mousePointer, solid.music, solid.neuter, solid.newspaper, solid.notEqual, solid.notesMedical, solid.objectGroup, solid.objectUngroup, solid.outdent, solid.paintBrush, solid.palette, solid.pallet, solid.paperPlane, solid.paperclip, solid.parachuteBox, solid.paragraph, solid.parking, solid.paste, solid.pause, solid.pauseCircle, solid.paw, solid.penSquare, solid.pencilAlt, solid.peopleCarry, solid.percent, solid.percentage, solid.phone, solid.phoneSlash, solid.phoneSquare, solid.phoneVolume, solid.piggyBank, solid.pills, solid.plane, solid.play, solid.playCircle, solid.plug, solid.plus, solid.plusCircle, solid.plusSquare, solid.podcast, solid.poo, solid.portrait, solid.poundSign, solid.powerOff, solid.prescriptionBottle, solid.prescriptionBottleAlt, solid.print, solid.procedures, solid.projectDiagram, solid.puzzlePiece, solid.qrcode, solid.question, solid.questionCircle, solid.quidditch, solid.quoteLeft, solid.quoteRight, solid.random, solid.receipt, solid.recycle, solid.redo, solid.redoAlt, solid.registered, solid.reply, solid.replyAll, solid.retweet, solid.ribbon, solid.road, solid.robot, solid.rocket, solid.rss, solid.rssSquare, solid.rubleSign, solid.ruler, solid.rulerCombined, solid.rulerHorizontal, solid.rulerVertical, solid.rupeeSign, solid.save, solid.school, solid.screwdriver, solid.search, solid.searchMinus, solid.searchPlus, solid.seedling, solid.server, solid.share, solid.shareAlt, solid.shareAltSquare, solid.shareSquare, solid.shekelSign, solid.shieldAlt, solid.ship, solid.shippingFast, solid.shoePrints, solid.shoppingBag, solid.shoppingBasket, solid.shoppingCart, solid.shower, solid.sign, solid.signInAlt, solid.signLanguage, solid.signOutAlt, solid.signal, solid.sitemap, solid.skull, solid.slidersH, solid.smile, solid.smoking, solid.smokingBan, solid.snowflake, solid.sort, solid.sortAlphaDown, solid.sortAlphaUp, solid.sortAmountDown, solid.sortAmountUp, solid.sortDown, solid.sortNumericDown, solid.sortNumericUp, solid.sortUp, solid.spaceShuttle, solid.spinner, solid.square, solid.squareFull, solid.star, solid.starHalf, solid.stepBackward, solid.stepForward, solid.stethoscope, solid.stickyNote, solid.stop, solid.stopCircle, solid.stopwatch, solid.store, solid.storeAlt, solid.stream, solid.streetView, solid.strikethrough, solid.stroopwafel, solid.`subscript`, solid.subway, solid.suitcase, solid.sun, solid.superscript, solid.sync, solid.syncAlt, solid.syringe, solid.table, solid.tableTennis, solid.tablet, solid.tabletAlt, solid.tablets, solid.tachometerAlt, solid.tag, solid.tags, solid.tape, solid.tasks, solid.taxi, solid.terminal, solid.textHeight, solid.textWidth, solid.th, solid.thLarge, solid.thList, solid.thermometer, solid.thermometerEmpty, solid.thermometerFull, solid.thermometerHalf, solid.thermometerQuarter, solid.thermometerThreeQuarters, solid.thumbsDown, solid.thumbsUp, solid.thumbtack, solid.ticketAlt, solid.times, solid.timesCircle, solid.tint, solid.toggleOff, solid.toggleOn, solid.toolbox, solid.trademark, solid.train, solid.transgender, solid.transgenderAlt, solid.trash, solid.trashAlt, solid.tree, solid.trophy, solid.truck, solid.truckLoading, solid.truckMoving, solid.tshirt, solid.tty, solid.tv, solid.umbrella, solid.underline, solid.undo, solid.undoAlt, solid.universalAccess, solid.university, solid.unlink, solid.unlock, solid.unlockAlt, solid.upload, solid.user, solid.userAlt, solid.userAltSlash, solid.userAstronaut, solid.userCheck, solid.userCircle, solid.userClock, solid.userCog, solid.userEdit, solid.userFriends, solid.userGraduate, solid.userLock, solid.userMd, solid.userMinus, solid.userNinja, solid.userPlus, solid.userSecret, solid.userShield, solid.userSlash, solid.userTag, solid.userTie, solid.userTimes, solid.users, solid.usersCog, solid.utensilSpoon, solid.utensils, solid.venus, solid.venusDouble, solid.venusMars, solid.vial, solid.vials, solid.video, solid.videoSlash, solid.volleyballBall, solid.volumeDown, solid.volumeOff, solid.volumeUp, solid.walking, solid.wallet, solid.warehouse, solid.weight, solid.wheelchair, solid.wifi, solid.windowClose, solid.windowMaximize, solid.windowMinimize, solid.windowRestore, solid.wineGlass, solid.wonSign, solid.wrench, solid.xRay, solid.yenSign ]
		}
		...
		public static var labels: [String] {
			return [ "Address Book", "Address Card", "adjust", "align-center", "align-justify", "align-left", "align-right", "Allergies", "ambulance", "American Sign Language Interpreting", "Anchor", "Angle Double Down", "Angle Double Left", "Angle Double Right", "Angle Double Up", "angle-down", "angle-left", "angle-right", "angle-up", "Archive", "Alternate Arrow Circle Down", "Alternate Arrow Circle Left", "Alternate Arrow Circle Right", "Alternate Arrow Circle Up", "Arrow Circle Down", "Arrow Circle Left", "Arrow Circle Right", "Arrow Circle Up", "arrow-down", "arrow-left", "arrow-right", "arrow-up", "Alternate Arrows", "Alternate Arrows Horizontal", "Alternate Arrows Vertical", "Assistive Listening Systems", "asterisk", "At", "Audio Description", "backward", "Balance Scale", "ban", "Band-Aid", "barcode", "Bars", "Baseball Ball", "Basketball Ball", "Bath", "Battery Empty", "Battery Full", "Battery 1/2 Full", "Battery 1/4 Full", "Battery 3/4 Full", "Bed", "beer", "bell", "Bell Slash", "Bicycle", "Binoculars", "Birthday Cake", "Blender", "Blind", "bold", "Lightning Bolt", "Bomb", "book", "Book Open", "bookmark", "Bowling Ball", "Box", "Box Open", "Boxes", "Braille", "Briefcase", "Medical Briefcase", "Broadcast Tower", "Broom", "Bug", "Building", "bullhorn", "Bullseye", "Burn", "Bus", "Calculator", "Calendar", "Alternate Calendar", "Calendar Check", "Calendar Minus", "Calendar Plus", "Calendar Times", "camera", "Retro Camera", "Capsules", "Car", "Caret Down", "Caret Left", "Caret Right", "Caret Square Down", "Caret Square Left", "Caret Square Right", "Caret Square Up", "Caret Up", "Shopping Cart Arrow Down", "Add to Shopping Cart", "certificate", "Chalkboard", "Chalkboard Teacher", "Area Chart", "Bar Chart", "Line Chart", "Pie Chart", "Check", "Check Circle", "Check Square", "Chess", "Chess Bishop", "Chess Board", "Chess King", "Chess Knight", "Chess Pawn", "Chess Queen", "Chess Rook", "Chevron Circle Down", "Chevron Circle Left", "Chevron Circle Right", "Chevron Circle Up", "chevron-down", "chevron-left", "chevron-right", "chevron-up", "Child", "Church", "Circle", "Circle Notched", "Clipboard", "Clipboard Check", "Clipboard List", "Clock", "Clone", "Closed Captioning", "Cloud", "Alternate Cloud Download", "Alternate Cloud Upload", "Code", "Code Branch", "Coffee", "cog", "cogs", "Coins", "Columns", "comment", "Alternate Comment", "Comment Dots", "Comment Slash", "comments", "Compact Disc", "Compass", "Compress", "Copy", "Copyright", "Couch", "Credit Card", "crop", "Crosshairs", "Crow", "Crown", "Cube", "Cubes", "Cut", "Database", "Deaf", "Desktop", "Diagnoses", "Dice", "Dice Five", "Dice Four", "Dice One", "Dice Six", "Dice Three", "Dice Two", "Divide", "DNA", "Dollar Sign", "Dolly", "Dolly Flatbed", "Donate", "Door Closed", "Door Open", "Dot Circle", "Dove", "Download", "Dumbbell", "Edit", "eject", "Horizontal Ellipsis", "Vertical Ellipsis", "Envelope", "Envelope Open", "Envelope Square", "Equals", "eraser", "Euro Sign", "Alternate Exchange", "exclamation", "Exclamation Circle", "Exclamation Triangle", "Expand", "Alternate Expand Arrows", "Alternate External Link", "Alternate External Link Square", "Eye", "Eye Dropper", "Eye Slash", "fast-backward", "fast-forward", "Fax", "Feather", "Female", "fighter-jet", "File", "Alternate File", "Archive File", "Audio File", "Code File", "Excel File", "Image File", "Medical File", "Alternate Medical File", "PDF File", "Powerpoint File", "Video File", "Word File", "Film", "Filter", "fire", "fire-extinguisher", "First Aid", "flag", "flag-checkered", "Flask", "Folder", "Folder Open", "font", "Font Awesome Full Logo", "Football Ball", "forward", "Frog", "Frown", "Futbol", "Gamepad", "Gas Pump", "Gavel", "Gem", "Genderless", "gift", "Martini Glass", "Glasses", "Globe", "Golf Ball", "Graduation Cap", "Greater Than", "Greater Than Equal To", "H Square", "Hand Holding", "Hand Holding Heart", "Hand Holding US Dollar", "Lizard (Hand)", "Paper (Hand)", "Peace (Hand)", "Hand Pointing Down", "Hand Pointing Left", "Hand Pointing Right", "Hand Pointing Up", "Pointer (Hand)", "Rock (Hand)", "Scissors (Hand)", "Spock (Hand)", "Hands", "Helping Hands", "Handshake", "Hashtag", "HDD", "heading", "headphones", "Heart", "Heartbeat", "Helicopter", "History", "Hockey Puck", "home", "hospital", "Alternate Hospital", "Hospital Symbol", "Hourglass", "Hourglass End", "Hourglass Half", "Hourglass Start", "I Beam Cursor", "Identification Badge", "Identification Card", "Alternate Identification Card", "Image", "Images", "inbox", "Indent", "Industry", "Infinity", "Info", "Info Circle", "italic", "key", "Keyboard", "Kiwi Bird", "Language", "Laptop", "leaf", "Lemon", "Less Than", "Less Than Equal To", "Alternate Level Down", "Alternate Level Up", "Life Ring", "Lightbulb", "Link", "Turkish Lira Sign", "List", "Alternate List", "list-ol", "list-ul", "location-arrow", "lock", "Lock Open", "Alternate Long Arrow Down", "Alternate Long Arrow Left", "Alternate Long Arrow Right", "Alternate Long Arrow Up", "Low Vision", "magic", "magnet", "Male", "Map", "map-marker", "Alternate Map Marker", "Map Pin", "Map Signs", "Mars", "Mars Double", "Mars Stroke", "Mars Stroke Horizontal", "Mars Stroke Vertical", "medkit", "Meh", "Memory", "Mercury", "Microchip", "microphone", "Alternate Microphone", "Alternate Microphone Slash", "Microphone Slash", "minus", "Minus Circle", "Minus Square", "Mobile Phone", "Alternate Mobile", "Money Bill", "Alternate Money Bill", "Wavy Money Bill", "Alternate Wavy Money Bill", "Money Check", "Alternate Money Check", "Moon", "Motorcycle", "Mouse Pointer", "Music", "Neuter", "Newspaper", "Not Equal", "Medical Notes", "Object Group", "Object Ungroup", "Outdent", "Paint Brush", "Palette", "Pallet", "Paper Plane", "Paperclip", "Parachute Box", "paragraph", "Parking", "Paste", "pause", "Pause Circle", "Paw", "Pen Square", "Alternate Pencil", "People Carry", "Percent", "Percentage", "Phone", "Phone Slash", "Phone Square", "Phone Volume", "Piggy Bank", "Pills", "plane", "play", "Play Circle", "Plug", "plus", "Plus Circle", "Plus Square", "Podcast", "Poo", "Portrait", "Pound Sign", "Power Off", "Prescription Bottle", "Alternate Prescription Bottle", "print", "Procedures", "Project Diagram", "Puzzle Piece", "qrcode", "Question", "Question Circle", "Quidditch", "quote-left", "quote-right", "random", "Receipt", "Recycle", "Redo", "Alternate Redo", "Registered Trademark", "Reply", "reply-all", "Retweet", "Ribbon", "road", "Robot", "rocket", "rss", "RSS Square", "Ruble Sign", "Ruler", "Ruler Combined", "Ruler Horizontal", "Ruler Vertical", "Indian Rupee Sign", "Save", "School", "Screwdriver", "Search", "Search Minus", "Search Plus", "Seedling", "Server", "Share", "Alternate Share", "Alternate Share Square", "Share Square", "Shekel Sign", "Alternate Shield", "Ship", "Shipping Fast", "Shoe Prints", "Shopping Bag", "Shopping Basket", "shopping-cart", "Shower", "Sign", "Alternate Sign In", "Sign Language", "Alternate Sign Out", "signal", "Sitemap", "Skull", "Horizontal Sliders", "Smile", "Smoking", "Smoking Ban", "Snowflake", "Sort", "Sort Alpha Down", "Sort Alpha Up", "Sort Amount Down", "Sort Amount Up", "Sort Down (Descending)", "Sort Numeric Down", "Sort Numeric Up", "Sort Up (Ascending)", "Space Shuttle", "Spinner", "Square", "Square Full", "Star", "star-half", "step-backward", "step-forward", "Stethoscope", "Sticky Note", "stop", "Stop Circle", "Stopwatch", "Store", "Alternate Store", "Stream", "Street View", "Strikethrough", "Stroopwafel", "subscript", "Subway", "Suitcase", "Sun", "superscript", "Sync", "Alternate Sync", "Syringe", "table", "Table Tennis", "tablet", "Alternate Tablet", "Tablets", "Alternate Tachometer", "tag", "tags", "Tape", "Tasks", "Taxi", "Terminal", "text-height", "text-width", "th", "th-large", "th-list", "Thermometer", "Thermometer Empty", "Thermometer Full", "Thermometer 1/2 Full", "Thermometer 1/4 Full", "Thermometer 3/4 Full", "thumbs-down", "thumbs-up", "Thumbtack", "Alternate Ticket", "Times", "Times Circle", "tint", "Toggle Off", "Toggle On", "Toolbox", "Trademark", "Train", "Transgender", "Alternate Transgender", "Trash", "Alternate Trash", "Tree", "trophy", "truck", "Truck Loading", "Truck Moving", "T-Shirt", "TTY", "Television", "Umbrella", "Underline", "Undo", "Alternate Undo", "Universal Access", "University", "unlink", "unlock", "Alternate Unlock", "Upload", "User", "Alternate User", "Alternate User Slash", "User Astronaut", "User Check", "User Circle", "User Clock", "User Cog", "User Edit", "User Friends", "User Graduate", "User Lock", "user-md", "User Minus", "User Ninja", "Add User", "User Secret", "User Shield", "User Slash", "User Tag", "User Tie", "Remove User", "Users", "Users Cog", "Utensil Spoon", "Utensils", "Venus", "Venus Double", "Venus Mars", "Vial", "Vials", "Video", "Video Slash", "Volleyball Ball", "volume-down", "volume-off", "volume-up", "Walking", "Wallet", "Warehouse", "Weight", "Wheelchair", "WiFi", "Window Close", "Window Maximize", "Window Minimize", "Window Restore", "Wine Glass", "Won Sign", "Wrench", "X-Ray", "Yen Sign" ]
		}
